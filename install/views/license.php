 ...
 * END LICENSE HEADER
 *
 * @description     install/views/license.php ->    APPNET OS installer view "license".
 */
?>
<?php $license = file_get_contents("../LICENSE/LICENSE_" . $active . ".html");?>
<div class="container">
    <div class="row">
            ...
            <form class="m-0" action="" method="post">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h5 class="mb-0">
                            <?php echo $strings["installer__license"];?>
                        </h5>
                    </div>
                    ...
                    <div class="card-body border-top">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="license__checkbox">
                                <?php echo $strings["installer__accept_checkbox"];?>
                            </label>
                        </div>
                    </div>
