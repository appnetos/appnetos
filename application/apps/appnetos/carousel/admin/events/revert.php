...
function revert($id)
{
    ...
    $database->delete($query, [md5('appnetos/carousel'), $id]);

    // Truncate database table "appnetos__carousel".
    $query = 'TRUNCATE TABLE ' . $prefix . '_appnetos__carousel_' . $id;
