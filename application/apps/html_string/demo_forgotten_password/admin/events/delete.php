...
{
    // Delete admin data.
    $dir = 'application/apps/html_string/demo_forgotten_password/';
    if (file_exists($dir . 'admin/controllers/demo_forgotten_password.php')) {
        unlink($dir . 'admin/controllers/demo_forgotten_password.php');
    }
    if (file_exists($dir . 'admin/css/demo_forgotten_password.css')) {
            unlink($dir . 'admin/css/demo_forgotten_password.css');
        }
    if (file_exists($dir . 'admin/events/delete.php')) {
        unlink($dir . 'admin/events/delete.php');
    }
    if (file_exists($dir . 'admin/js/demo_forgotten_password.js')) {
        unlink($dir . 'admin/js/demo_forgotten_password.js');
    }
    if (file_exists($dir . 'admin/views/demo_forgotten_password.tpl')) {
        unlink($dir . 'admin/views/demo_forgotten_password.tpl');
    }
    if (file_exists($dir . 'admin/views/demo_forgotten_password__menu.tpl')) {
        unlink($dir . 'admin/views/demo_forgotten_password__menu.tpl');
    }
    if (file_exists($dir . 'admin/controllers/demo_forgotten_password.php')) {
        unlink($dir . 'admin/controllers/demo_forgotten_password.php');
    }
    ...
    if (file_exists($dir . 'application/models/demo_forgotten_password.php')) {
        unlink($dir . 'application/models/demo_forgotten_password.php');
    }
    if (file_exists($dir . 'application/css/demo_forgotten_password.css')) {
            unlink($dir . 'application/css/demo_forgotten_password.css');
    }
