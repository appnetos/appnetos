...
// Namespace.
namespace appnetos\html_string\demo_forgotten_password;

// Use.
use core\objects;

// Controller.
class demo_forgotten_password
{
     ...
     * @var string.
     */
    public $name = 'demo_forgotten_password';
    ...
    public function editCss($content)
    {
        ...
        // Create CSS file.
        file_put_contents($this->directoryCss . 'demo_forgotten_password.css', $content);
    }
    ...
    {
        if (file_exists($this->directoryCss . 'demo_forgotten_password.css')) {
            return file_get_contents($this->directoryCss . 'demo_forgotten_password.css');
        }
    }
}