...
{
    // Delete admin data.
    $dir = 'application/apps/html_string/demo_sign_in/';
    if (file_exists($dir . 'admin/controllers/demo_sign_in.php')) {
        unlink($dir . 'admin/controllers/demo_sign_in.php');
    }
    if (file_exists($dir . 'admin/css/demo_sign_in.css')) {
            unlink($dir . 'admin/css/demo_sign_in.css');
        }
    if (file_exists($dir . 'admin/events/delete.php')) {
        unlink($dir . 'admin/events/delete.php');
    }
    if (file_exists($dir . 'admin/js/demo_sign_in.js')) {
        unlink($dir . 'admin/js/demo_sign_in.js');
    }
    if (file_exists($dir . 'admin/views/demo_sign_in.tpl')) {
        unlink($dir . 'admin/views/demo_sign_in.tpl');
    }
    if (file_exists($dir . 'admin/views/demo_sign_in__menu.tpl')) {
        unlink($dir . 'admin/views/demo_sign_in__menu.tpl');
    }
    if (file_exists($dir . 'admin/controllers/demo_sign_in.php')) {
        unlink($dir . 'admin/controllers/demo_sign_in.php');
    }
    ...
    if (file_exists($dir . 'application/models/demo_sign_in.php')) {
        unlink($dir . 'application/models/demo_sign_in.php');
    }
    if (file_exists($dir . 'application/css/demo_sign_in.css')) {
            unlink($dir . 'application/css/demo_sign_in.css');
    }
