...
// Namespace.
namespace appnetos\html_string\demo_sign_up;
...
class demo_sign_up
{
    ...
    public function editCss($content)
    {
        ...
        // Create CSS file.
        file_put_contents($this->directoryCss . 'demo_sign_up.css', $content);
    }
    ...
    {
        if (file_exists($this->directoryCss . 'demo_sign_up.css')) {
            return file_get_contents($this->directoryCss . 'demo_sign_up.css');
        }
    }
}