...
{
    // Delete admin data.
    $dir = 'application/apps/html_string/demo_home/';
    if (file_exists($dir . 'admin/controllers/demo_home.php')) {
        unlink($dir . 'admin/controllers/demo_home.php');
    }
    if (file_exists($dir . 'admin/css/demo_home.css')) {
            unlink($dir . 'admin/css/demo_home.css');
        }
    if (file_exists($dir . 'admin/events/delete.php')) {
        unlink($dir . 'admin/events/delete.php');
    }
    if (file_exists($dir . 'admin/js/demo_home.js')) {
        unlink($dir . 'admin/js/demo_home.js');
    }
    if (file_exists($dir . 'admin/views/demo_home.tpl')) {
        unlink($dir . 'admin/views/demo_home.tpl');
    }
    if (file_exists($dir . 'admin/views/demo_home__menu.tpl')) {
        unlink($dir . 'admin/views/demo_home__menu.tpl');
    }
    if (file_exists($dir . 'admin/controllers/demo_home.php')) {
        unlink($dir . 'admin/controllers/demo_home.php');
    }
    ...
    if (file_exists($dir . 'application/models/demo_home.php')) {
        unlink($dir . 'application/models/demo_home.php');
    }
    if (file_exists($dir . 'application/css/demo_home.css')) {
            unlink($dir . 'application/css/demo_home.css');
    }
