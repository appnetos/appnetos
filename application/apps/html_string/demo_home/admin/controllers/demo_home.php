...
// Namespace.
namespace appnetos\html_string\demo_home;
...
class demo_home
{
    ...
    public function editCss($content)
    {
        ...
        // Create CSS file.
        file_put_contents($this->directoryCss . 'demo_home.css', $content);
    }
    ...
    {
        if (file_exists($this->directoryCss . 'demo_home.css')) {
            return file_get_contents($this->directoryCss . 'demo_home.css');
        }
    }
}