...
// Model "admin\apps\static_bottom__search".
class static_bottom__search
{
    ...
    public function init()
    {
        ...
        $render->assign('admin__apps__static_bottom__search', $this);
    ...
    public function update()
    {
        ...
        // Get POST parameters.
        $view = $post->get('admin__apps__static_bottom__parameters');
