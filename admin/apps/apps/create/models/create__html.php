...
class create__html
{
    ...
    public function init()
    {
        ...
        $render->assign('admin__apps__create__html', $this);
    ...
    public function build()
    {
        ...
        $directory = 'application/apps/html/';
        ...
        $row = $database->selectRow($query, [$this->name, "appnetos\\html\\" . $this->name]);
        if ($row) {
            $this->render('admin__apps__create__err_name_exists');
        }
        ...
        // Install application.
        $install->setNamespace("appnetos\\html\\" . $formattedName);
        $install->setDirectory('html');
    ...
    protected function copyFiles()
    {
        ...
        // Create directories.
        $source = 'admin/apps/apps/create/files/html/';
        $directory = 'application/apps/html/';
        ...
        $content = file_get_contents($source . 'application/views/global.txt');
        file_put_contents($target . '/application/views/global.tpl', $content);
        $content = file_get_contents($source . 'application/views/view.txt');
        $content = str_replace('***FORMATTED_NAME***', $formattedName, $content);
    ...
    protected function render($error = null, $confirm = null)
    {
        ...
        // Render template.
        $output = $render->fetch('admin/apps/apps/create/views/create__html.tpl');
        echo $output;
        exit();
    }
