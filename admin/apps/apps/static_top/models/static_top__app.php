...
// Model "admin\apps\static_top__app".
class static_top__app
{
    ...
    {
        // Get used objects.
        $staticTopAppsList = objects::get('admin/apps/static_top__apps_list');
        ...
        $indexes = array_keys($staticTopAppsList->staticTop, $this->id);
        $this->staticTop = count($indexes);
        $indexes = array_keys($staticTopAppsList->staticBottom, $this->id);
