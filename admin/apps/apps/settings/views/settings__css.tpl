    ...
    <div class="container info-hide">
        <div class="row">
            <div class="col-12 mt-4 text-justify">
                {$strings->get('admin__apps__settings__css_info')}
            </div>
        </div>
    </div>
{/if}
...
{* AJAX error *}
{if $admin__apps__settings__css->ajaxError}
    <div class="container">
        <div id="admin__apps__settings__ajax_error" class="row d-none">
            <div class="col-12 mt-4">
                <div class="alert alert-danger m-0">
                    {$admin__apps__settings__css->ajaxError}
                </div>
            </div>
        </div>
    </div>
...
{* AJAX confirm *}
{if $admin__apps__settings__css->ajaxConfirm}
    <div class="container">
        <div id="admin__apps__settings__ajax_confirm" class="row d-none">
            <div class="col-12 mt-4">
                <div class="alert alert-success m-0">
                    {$admin__apps__settings__css->ajaxConfirm}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 mt-4">
            <div class="card">
                ...
                <div class="border border-light">
                    <textarea class="w-100" id="admin__apps__settings__css" data-type="admin__apps__settings__css" rows="30">{$admin__apps__settings__app->getCss()}</textarea>
                </div>
                <div class="text-right m-4">
                    <button type="button" class="btn btn-primary text-light" onclick="admin__apps__settings.csex()">
