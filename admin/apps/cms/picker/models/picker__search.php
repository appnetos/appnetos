...
// Model "admin\cms\picker__search".
class picker__search
{
    ...
    public function init()
    {
        ...
        $render->assign('admin__cms__picker__search', $this);

        // Get used objects.
        $this->_session = objects::get('session');

        // Get search.
        $search = $this->_session->get('cms__picker__search');
    ...
    protected function set()
    {
        ...
        $this->_session->set('cms__picker__search', json_encode($this));
    }
    ...
    public function update()
    {
        ...
        // Get POST parameters.
        $number = $post->get('admin__cms__picker__search_number');
        $number = (int)$number;
        $search = $post->get('admin__cms__picker__search_search');
        $area = $post->get('admin__cms__picker__search_area');
        $area = (int)$area;
        $order = $post->get('admin__cms__picker__search_order');
