...
// Model "admin\cms\manage_apps__app".
class manage_apps__app
{
    ...
    protected function initData()
    {
        ...
        $indexes = array_keys($manageAppsAppsList->staticTop, $this->id);
        $this->staticTop = count($indexes);
        $indexes = array_keys($manageAppsAppsList->staticBottom, $this->id);
