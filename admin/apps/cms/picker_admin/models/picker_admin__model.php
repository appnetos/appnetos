...
// Controller "admin\cms\picker_admin__model".
class picker_admin__model
{
    ...
    public function init()
    {
        ...
        $this->_render->assign('admin__cms__picker_admin__model', $this);

        // Initialize objects.
        $uriPickerSearch = objects::get('admin\cms\picker_admin__search', true);
        $uriPickerSearch->init();
        $uriPickerUrisList = objects::get('admin\cms\picker_admin__uris_list', true);
