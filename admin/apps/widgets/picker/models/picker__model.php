...
// Model "admin\widgets\picker__model".
class picker__model
{
    ...
    public function init()
    {
        ...
        $this->_render->assign('admin__widgets__picker__model', $this);

        // Initialize objects.
        $pickerSearch = objects::get('admin/widgets/picker__search', true);
        $pickerSearch->init();
        $pickerWidgetsList = objects::get('admin/widgets/picker__widgets_list', true);
        $pickerWidgetsList->init();
    }
