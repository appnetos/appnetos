...
{* Button *}
<div id="admin__menu__language_menu__btn" data-toggle="modal" data-target="#admin__menu__language_menu__modal_languages">
    <svg id="admin__menu__language_menu__svg" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 75 75" x="0" y="100">
        <defs id="admin__menu__language_menu_svg_1" />
        <g
                id="admin__menu__language_menu_svg_2"
            ...
            <path
                    ...
                    id="admin__menu__language_menu_svg_3"
            ...
            <path
                    ...
                    id="admin__menu__language_menu_svg_4"
                    style="opacity:1;fill:currentColor" />
        </g>
        <g
                id="admin__menu__language_menu_svg_5"
                transform="scale(0.13837638)">
            <path
                    ...
                    id="admin__menu__language_menu_svg_6"
            ...
            <path
                    ...
                    id="admin__menu__language_menu_svg_7"
                    style="opacity:0;fill:#ffffff" />
        </g>
    </svg>
    <span>{$admin__menu__language_menu__model->getAdminActive()}</span>
</div>

{* Modal languages *}
<div class="modal fade" id="admin__menu__language_menu__modal_languages" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-dark text-light">
                <h5 class="modal-title">
                    {$strings->get('admin__menu__language_menu__select')}
                </h5>
            ...
            <div class="modal-body">
                {$render->include('admin/apps/menu/language_menu/views/language_menu__languages_list.tpl')}
            </div>
            <div class="modal-footer bg-light">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">
                    {$strings->get('admin__menu__language_menu__close')}
                </button>
            </div>
        </div>
    </div>
