...
// Model "admin\groups\admin_groups__model".
class admin_groups__model
{
    /**
     * Object "core\render".
     *
    ...
    {
        // Assign.
        objects::set('admin/groups/admin_groups__model', $this);
        $this->_render = objects::get('render');
        $this->_render->assign('admin__groups__admin_groups__model', $this);

        // Initialize objects.
        $groupsSearch = objects::get('admin/groups/admin_groups__search', true);
        $groupsSearch->init();
