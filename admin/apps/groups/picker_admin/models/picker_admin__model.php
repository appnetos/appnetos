...
// Model "admin\groups\picker_admin__model".
class picker_admin__model
{
    ...
    public function init()
    {
        ...
        $this->_render->assign('admin__groups__picker_admin__model', $this);

        // Initialize objects.
        $pickerSearch = objects::get('admin/groups/picker_admin__search', true);
        $pickerSearch->init();
        $pickerAppList = objects::get('admin/groups/picker_admin__groups_list', true);
        $pickerAppList->init();
    }
